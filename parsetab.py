...
_lr_productions = [
  ...
  ('statement -> NAME = expression','statement',3,'p_statement_assign','main.py',69),
  ('statement -> expression','statement',1,'p_statement_expr','main.py',74),
  ('expression -> expression + expression','expression',3,'p_expression_binop','main.py',79),
  ('expression -> expression - expression','expression',3,'p_expression_binop','main.py',80),
  ('expression -> expression * expression','expression',3,'p_expression_binop','main.py',81),
  ('expression -> expression / expression','expression',3,'p_expression_binop','main.py',82),
  ('expression -> - expression','expression',2,'p_expression_uminus','main.py',94),
  ('expression -> ( expression )','expression',3,'p_expression_group','main.py',99),
  ('expression -> NUMBER','expression',1,'p_expression_number','main.py',104),
  ('expression -> NAME','expression',1,'p_expression_name','main.py',109),
]
